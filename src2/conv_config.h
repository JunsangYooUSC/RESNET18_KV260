...
constexpr unsigned BB3_SKIP_WEIGHT_SIZE = BB2_SKIP_C * BB3_SKIP_C * BB3_SKIP_K * BB3_SKIP_K / WEIGHT_PACK;
...
constexpr unsigned BB5_SKIP_WEIGHT_SIZE = BB4_SKIP_C * BB5_SKIP_C * BB5_SKIP_K * BB5_SKIP_K / WEIGHT_PACK;
...
constexpr unsigned BB7_SKIP_WEIGHT_SIZE = BB6_SKIP_C * BB7_SKIP_C * BB7_SKIP_K * BB7_SKIP_K / WEIGHT_PACK;
...
constexpr unsigned MAX_WEIGHT_MEM_SIZE = ACT_PACK * std::max({
...
constexpr unsigned MAX_BN_WEIGHT_MEM_SIZE = ACT_PACK * std::max({
