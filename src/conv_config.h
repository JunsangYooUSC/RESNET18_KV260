...
constexpr unsigned MEM0_SIZE = (MAX_POOL_OUT_SIZE / ACT_PACK > IN_C*IN_H*IN_W/ACT_PACK) ? MAX_POOL_OUT_SIZE / ACT_PACK : IN_C*IN_H*IN_W/ACT_PACK;
constexpr unsigned MEM1_SIZE = (CONV1_OUT_SIZE / ACT_PACK > IN_C*IN_H*IN_W/ACT_PACK) ? CONV1_OUT_SIZE / ACT_PACK : IN_C*IN_H*IN_W/ACT_PACK;
constexpr unsigned MEM2_SIZE = (MAX_POOL_OUT_SIZE / ACT_PACK > IN_C*IN_H*IN_W/ACT_PACK) ? BB1_CONV2_OUT_SIZE / ACT_PACK : IN_C*IN_H*IN_W/ACT_PACK;
