...
set genomeRtd $env(RT_TMP)/791DB0E0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {conv_kernel__GB4}]"
...
set genomeName [subst -nocommands -novariables {conv_kernel__GB4}]
