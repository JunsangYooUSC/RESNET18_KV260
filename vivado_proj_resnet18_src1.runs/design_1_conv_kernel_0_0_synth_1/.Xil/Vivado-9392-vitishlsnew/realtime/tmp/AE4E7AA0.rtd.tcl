...
set genomeRtd $env(RT_TMP)/AE4E7AA0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {conv_kernel__GB3}]"
...
set genomeName [subst -nocommands -novariables {conv_kernel__GB3}]
