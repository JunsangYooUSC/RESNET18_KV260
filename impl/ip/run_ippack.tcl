...
set Library     "hls"
set IPName      "conv_kernel"
set Version     "1.0"
set DisplayName "Conv_kernel"
set Revision    "2113874169"
...
set xo_kernel_name "conv_kernel"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/junsang/projects/EE511/hw4/resnet_src1/resnet_src1/solution1"
set debug_dir "/home/junsang/projects/EE511/hw4/resnet_src1/resnet_src1/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {conv_kernel_flow_control_loop_pipe_sequential_init
conv_kernel_mul_32s_32s_32_1_1
conv_kernel_flow_control_loop_pipe_sequential_init
conv_kernel_flow_control_loop_pipe_sequential_init
...
conv_kernel_flow_control_loop_pipe_sequential_init
conv_kernel_mul_30ns_30ns_64_1_1
conv_kernel_mul_32ns_38ns_70_1_1
conv_kernel_mul_32ns_60ns_96_1_1
conv_kernel_flow_control_loop_pipe_sequential_init
conv_kernel_flow_control_loop_pipe_sequential_init
conv_kernel_flow_control_loop_pipe_sequential_init
conv_kernel_flow_control_loop_pipe_sequential_init
...
controller
conv_kernel_Pipeline_conv_kernel_loop2
load_input_Pipeline_load_input_loop6
load_input_Pipeline_load_input_loop14_load_input_loop15
load_input
conv_kernel_Pipeline_load_weight_loop9
PE_Pipeline_pe_loop1_pe_loop3_pe_loop5_pe_loop6
PE_Pipeline_pe_loop11_pe_loop12
PE_Pipeline_pe_loop18
PE_Pipeline_pe_loop20_pe_loop21
PE
conv_kernel_Pipeline_batch_norm_loop1_batch_norm_loop3_batch_norm_loop5_batch_no
conv_kernel_Pipeline_skip_conn_loop1_skip_conn_loop3_skip_conn_loop5_skip_conn_l
conv_kernel_Pipeline_sotre_output_loop6
max_pool_Pipeline_max_pool_loop1_max_pool_loop2_max_pool_loop3
max_pool
avg_pool_Pipeline_avg_pool_loop1
avg_pool
conv_kernel_Pipeline_fc_loop1
conv_kernel_Pipeline_conv_kernel_loop3
conv_kernel
}
set kernel_xo ""
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 act_mem_1 W 0x0 "Data signal of act_mem" {{0 32 act_mem W 0 "Bit 31 to 0 of act_mem"}}} {0x14 act_mem_2 W 0x0 "Data signal of act_mem" {{0 32 act_mem W 0 "Bit 63 to 32 of act_mem"}}} {0x1c act_in_1 W 0x0 "Data signal of act_in" {{0 32 act_in W 0 "Bit 31 to 0 of act_in"}}} {0x20 act_in_2 W 0x0 "Data signal of act_in" {{0 32 act_in W 0 "Bit 63 to 32 of act_in"}}} {0x28 act_out_1 W 0x0 "Data signal of act_out" {{0 32 act_out W 0 "Bit 31 to 0 of act_out"}}} {0x2c act_out_2 W 0x0 "Data signal of act_out" {{0 32 act_out W 0 "Bit 63 to 32 of act_out"}}} {0x34 weight_mem_1 W 0x0 "Data signal of weight_mem" {{0 32 weight_mem W 0 "Bit 31 to 0 of weight_mem"}}} {0x38 weight_mem_2 W 0x0 "Data signal of weight_mem" {{0 32 weight_mem W 0 "Bit 63 to 32 of weight_mem"}}} {0x40 bn_weight_mem_1 W 0x0 "Data signal of bn_weight_mem" {{0 32 bn_weight_mem W 0 "Bit 31 to 0 of bn_weight_mem"}}} {0x44 bn_weight_mem_2 W 0x0 "Data signal of bn_weight_mem" {{0 32 bn_weight_mem W 0 "Bit 63 to 32 of bn_weight_mem"}}} {0x4c start_layer_1 W 0x0 "Data signal of start_layer" {{0 32 start_layer W 0 "Bit 31 to 0 of start_layer"}}} {0x50 start_layer_2 W 0x0 "Data signal of start_layer" {{0 32 start_layer W 0 "Bit 63 to 32 of start_layer"}}} {0x58 end_layer_1 W 0x0 "Data signal of end_layer" {{0 32 end_layer W 0 "Bit 31 to 0 of end_layer"}}} {0x5c end_layer_2 W 0x0 "Data signal of end_layer" {{0 32 end_layer W 0 "Bit 63 to 32 of end_layer"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
